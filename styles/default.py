...
default = {
    ...
    'landusage_data': {
        ...
        9: '"geometry from (select geometry ,osm_id, type, OSM_NAME_COLUMN as name from OSM_PREFIX_landusages_gen1 where type in (\'forest\',\'wood\',\'farmland\',\'orchard\',\'vineyard\',\'plant_nursery\',\'grass\',\'grassland\',\'meadow\',\'industrial\',\'commercial\',\'residential\')) as foo using unique osm_id using srid=OSM_SRID"',
